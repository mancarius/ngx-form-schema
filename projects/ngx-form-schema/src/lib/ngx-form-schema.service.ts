...
export class NgxFormSchemaBuilder {
  ...
  public group<UserRole extends string>(template: GroupSchemaTemplate<UserRole>, validatorOrOpts?: ValidatorFn | AbstractControlOptions & { userRoles: UserRole[] } | ValidatorFn[]) {
